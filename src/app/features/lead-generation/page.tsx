...
export default function LeadGen() {
  ...
  return (
    <>
      ...
      <div className="max-w-full bg-[#101828]" style={{ backgroundImage: `url(${gradientPruple})`, backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: 'center', }}>
        <div className="px-4 max-w-[1200px] mx-auto flex flex-col justify-center items-center pt-20 text-white">
          ...
          <div className="px-32 flex flex-col items-center pb-20">
            ...
            <p className="text-[#7d89b0] text-lg text-center pt-5 ">Identify turns your anonymous website traffic into actionable leads and information in real-time. So you can make the most of every marketing dollar and close more deals.</p>
            <button className="mt-4 flex items-center justify-center gap-2 rounded-full pt-2 pb-[6px] pl-4 pr-3 text-white bg-[#ffffff1a] border-[1.5px] border-[#ffffff1a] text-sm backdrop-filter">Start 14-Day Free Trial<svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
              <path d="M3.33301 10.6196H16.6663M16.6663 10.6196L11.6663 5.61963M16.6663 10.6196L11.6663 15.6196" stroke="currentColor" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path></svg>
            </button>
          </div>
            ...
            <div className="w-1/2">
              ...
              <div className="flex gap-5 items-start">
                ...
                <div>
                  ...
                  <p className="text-[#7d89b0] text-lg">Enrich each identified company and your CRM with up to date and detailed information such as industry, size, location etc.</p>
                </div>
              </div>
              ...
              <div className="flex gap-5 items-start mt-10">
                ...
                <div>
                  ...
                  <p className="text-[#7d89b0] text-lg">Follow lead journeys from source to close – get the full picture on what leads are doing, not only those who convert.</p>
                </div>
              </div>

              <div className="flex gap-5 items-start mt-10">
                <Image src={Prospect} alt="propsect" width={50} height={50} className="object-contain" />
                <div>
                  <h2 className="text-lg font-semibold">Propsect</h2>
                  <p className="text-[#7d89b0] text-lg">Use key pieces of information to to select the right decision maker and pull contact details from the dashboard.</p>
                </div>
              </div>
      ...
      <div className="px-4 max-w-[1200px] mx-auto flex flex-col justify-center items-center pt-20">
        <div className="px-32 flex flex-col items-center pb-20">
          ...
          <p className="text-lg text-center pt-5 text-[#475467]">Group and segment leads by company attributes and behaviours so you can put your marketing and sales resources to work on customers, not browsers.</p>
        </div>
        ...
        <div className="flex gap-2">
          ...
          <div className="w-2/6">
            ...
            <div className="mt-8">
              ...
              <p className="text-[#667085] text-base leading-7 tracking-wide">Define company attributes and behaviours to configure lead scoring. Trigger automations and manage your website traffic intelligently. <br></br><span className="block pt-4">Collect great fit leads on autopilot so you can spend more time retargeting and selling to buyers, not browsers.</span></p>
            </div>
