    ...
    <>
      <div>
        <HeroSection
          ...
          paragraphText="ClientiDirect dă putere echipelor B2B să înțeleagă, să implice și să transforme vizitatorii anonimi ai site-ului web în potențiali clienți, utilizând tehnologia de ultimă oră de identificare, urmărirea în timp real a vizitatorilor și informații despre public bazate pe date."
          maxWidth="960px"
          bgColor="#070b18"
        />
