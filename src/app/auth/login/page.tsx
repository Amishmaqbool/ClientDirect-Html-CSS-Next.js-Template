    ...
    return(
        ...
        <form className="py-12 w-full flex flex-col items-center">
            <div className="flex flex-col justify-center items-center mb-4">
             ...
             <div className="mt-6 flex flex-col text-center">
                <h2 className="text-3xl text-[#111827] font-bold leading-9 tracking-tight">Welcome back</h2>
                <p className="text-gray-500 mt-1 leading-8 text-[15px] font-normal">Please enter your details.</p>
             </div>
            </div>
        ...
        <div className="flex justify-between gap-2">
                ...
                >
                  <input
                    ...
                    className="text-gray-500 px-4 py-2 w-4 h-4"
                  />
                  <div className="custom-checkbox"></div>
                  <span className="ml-2 mt-1 text-sm text-gray-500 leading-8">
                    Remember Me
                  </span>
                </label>
                </div>
               <div>
                <p className="text-blue-600 hover:text-blue-500 text-sm mt-2">Forgot your password?</p></div>
        </div>

        <button className="mt-[2px] border border-blue-700 bg-blue-600 align-middle py-2 font-medium text-sm w-full max-w-[350px] rounded-lg text-white cursor-pointer hover:bg-blue-700">Sign in</button>
        ...
        <button className="border border-gray-300 w-full max-w-[350px] py-2 font-medium text-sm text-gray-700 rounded-md flex items-center justify-center mb-3 hover:bg-gray-100">
          ...
          <p className="py-8 text-sm text-[#020817]">
            No account yet? <a href="/auth/signup" className="text-blue-600 hover:text-blue-500">Start your 14-day free trial</a>
          </p>
