...
const DataSection = () => {
  return (
    <>
    <div className="lg:px-32 max-lg:px-4 flex flex-col items-center pb-10 md:pb-20">
        ...
        <button className="flex items-center justify-center gap-2 font-semibold rounded-full py-2 pl-4 pr-3 text-white bg-[#101828] border-[1.5px] border-[#00000026] text-sm">Start 14-Day Free Trial<svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
