...
const CallToActionSection = () => {
  return (
    <div className="px-6">
      <div className="max-lg:h-[650px] c-cta--call-pricing relative overflow-hidden bg-[#101828] max-sm:px-6 rounded-[16px] pt-14 pb-0 sm:pl-12 flex max-w-[1240px] mx-auto">
