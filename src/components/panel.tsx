...
export default function Panel() {
  return (
    <div className='max-xl:px-8 max-md:px-4'>
      <div className="relative max-w-[1216px] -mt-28 px-[255px] max-md:px-5 mx-auto z-10 bg-[#3257ff] rounded-2xl py-[96px] text-center text-white overflow-hidden -mb-[295px]">
        <div className="max-w-[706px] flex flex-col items-center justify-center relative z-20 max-md:max-w-[918.4px]">
          ...
          <p className="text-lg mb-[30px] mt-4 text-[#d1e0ff] max-md:max-w-[580px]">
        ...
        {/* absolute */}
        <div className=" inset-0 opacity-10 bg-cover bg-no-repeat z-10" style={{ backgroundImage: 'url(https://cdn.prod.website-files.com/64084dfdb78deb68d06600ed/641c3ad…_noiseBig.png)' }}></div>
