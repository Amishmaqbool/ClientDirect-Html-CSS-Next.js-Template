...
export const pros=[
  {
    "id": 1,
    "title": "Califică",
    "description": "Califică automat leadurile și mută-le în următoarea etapă a procesului tău de vânzări.",
    "image": "qualify.webp"
  },
  {
    "id": 2,
    "title": "Prioritizează",
    "description": "Investește timpul în prospecți promițători prioritizând leadurile cu cea mai mare intenție.",
    "image": "prioritize.webp"
  },
  {
    "id": 3,
    "title": "Asignare",
    "description": "Notifică și asignează membri ai echipei în timp ce redirecționezi leadurile către platformele tale preferate.",
    "image": "assign.webp"
  },
  {
    "id": 4,
    "title": "Exportă",
    "description":"Exportă datele despre leaduri și vizite în mai multe formate sau sincronizează-le cu alte instrumente.",
    "image": "export.webp"
  }
];
...
export const data = [
  {
    id: 1,
    title: "Integrează",
    description: "Conectează-te cu instrumentele folosite de echipele tale și trimite leaduri calificate sau pre-calificate împreună cu informații îmbogățite despre companie.",
    image: Integrate,
  },
  {
    id: 2,
    title: "Notifică",
    description: "Configurează notificări personalizate pentru actualizările cu intenții ridicate, astfel încât conversațiile să rămână relevante și tranzacțiile să se închidă mai repede.",
    image: Notify,
  },
  {
    id: 3,
